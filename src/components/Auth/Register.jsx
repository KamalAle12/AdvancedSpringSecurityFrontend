...
import { signUp } from '../../assets/services/api'; // Import signUp function
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-amber-50 text-black p-6 md:p-10">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">Join Us Today!</h2>
        <p className="text-lg text-center">Create an account to access exclusive features and manage your profile with ease.</p>
        <img
